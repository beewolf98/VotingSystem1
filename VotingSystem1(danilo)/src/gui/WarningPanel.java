...
public class WarningPanel extends JPanel {
	...
	public WarningPanel() {
		...
		JLabel warningMessage = new JLabel("<html>E' vietato introdurre all'interno delle cabine elettorali telefoni cellulari o altre apparecchiature in grado di fotografare o registrare immagini. Chiunque contravviene al divieto di cui al comma 1 è punito con l'arresto da tre a sei mesi e con l'ammenda da 300 a 1000 euro.</html>");
